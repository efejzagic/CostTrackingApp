...
import { addOrder } from "../../state/orders";
...
const Nav = () => {
  ...
  const HandleOrder = () => {
    ...
    if (isEmpty) {
      ...
      dispatch(addOrder(createOrderDTO)); //TODO: fix this
    }
  };
        ...
        <div style={buttonGroupStyle}>
          <ButtonGroup variant="text" aria-label="text button group">
            ...
            {roles.includes("Storage Manager") && (
              <Button onClick={() => navigate("/article")} style={buttonStyle}>
                Articles
              </Button>
            )}
            {roles.includes("Storage Manager") && (
              <Button onClick={() => navigate("/supplier")} style={buttonStyle}>
                Suppliers
              </Button>
            )}
